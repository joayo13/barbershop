...
function MobileMenu({setMobileMenuActive, slide}) {
  return (
    <div style={slide === 'left' ? {animation: 'slideLeft 0.5s ease forwards'} : {animation: 'slideRight 0.5s ease forwards'}} className='w-full text-center p-2 md:w-2/5 fixed right-0 top-0 h-full bg-black bg-opacity-90 text-neutral-300 z-20'>
