...
function ServicesSelect({setSelectedService}) {
  return (
    <select defaultValue={'Signature Cut & Style'} className='bg-neutral-300 text-ellipsis w-60 border border-red-800 text-red-800' onChange={(e) => setSelectedService(e.target.value)}>
